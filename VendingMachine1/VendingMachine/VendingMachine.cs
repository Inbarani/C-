...
namespace VendingMachine
{
    ...
    public class VendingMachine
    {
        ...
        {
            this.bottleCount = initialBottleCount;
        ...
        {
            if(numberOfNewBottles > 0) 
            { bottleCount += numberOfNewBottles; }
        ...
        {
            if (IsSoldOut() || insertedCash < bottlePrice)
            {
                return -1.0;
            }
            ...
            double change = insertedCash - bottlePrice;
            insertedCash = 0;
        ...
        {
            return $"Bottles left: {this.bottleCount}\nBottle price: {this.bottlePrice} euroa\nMoney earned: {this.earnedCash} euroa";
        }
